package com.chaychan.lx.ui.view;
...
import com.chaychan.lx.relation.ShowPicRelation;
...
public class NewsDetailHeaderView extends FrameLayout {
    ...
    public void setDetail(NewsDetail detail,LoadWebListener listener) {
        ...
        if (detail.media_user == null) {
            ...
            mTvTime.setText(com.chaychan.lx.utils.DateUtils.getShortTime(detail.publish_time * 1000L));
        }
