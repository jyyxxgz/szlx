...
import com.chaychan.lx.constants.Constant;
import com.chaychan.lx.model.entity.News;
import com.chaychan.lx.model.entity.NewsRecord;
import com.chaychan.lx.model.event.TabRefreshCompletedEvent;
import com.chaychan.lx.model.event.TabRefreshEvent;
import com.chaychan.lx.model.event.DetailCloseEvent;
import com.chaychan.lx.ui.activity.NewsDetailBaseActivity;
import com.chaychan.lx.ui.activity.NewsDetailDetailActivity;
import com.chaychan.lx.ui.activity.VideoDetailActivity;
import com.chaychan.lx.ui.activity.WebViewActivity;
import com.chaychan.lx.ui.adapter.NewsAdapter;
import com.chaychan.lx.ui.base.BaseFragment;
import com.chaychan.lx.ui.presenter.NewsListPresenter;
import com.chaychan.lx.utils.ListUtils;
import com.chaychan.lx.utils.NetWorkUtils;
import com.chaychan.lx.utils.NewsRecordHelper;
import com.chaychan.lx.utils.UIUtils;
import com.chaychan.lx.view.lNewsListView;
import com.chaychan.lx.widget.banner.BannerBaseAdapter;
import com.chaychan.lx.widget.banner.BannerView;
...
public class NewsListFragment extends BaseFragment<NewsListPresenter> implements lNewsListView, BGARefreshLayout.BGARefreshLayoutDelegate, BaseQuickAdapter.RequestLoadMoreListener, View.OnClickListener {
    ...
    private void initBanner(){
        bannerLayout = getActivity().getLayoutInflater().inflate(R.layout.home_head_layout, null);
        View view1 = bannerLayout.findViewById(R.id.banner_public);
        TextView textView1 = (TextView) view1.findViewById(R.id.tv_banner_name);
        textView1.setText("政策发布");
        view1.setOnClickListener(this);
        View view2 = bannerLayout.findViewById(R.id.banner_parse);
        TextView textView2 = (TextView) view2.findViewById(R.id.tv_banner_name);
        textView2.setText("政策解读");
        view2.setOnClickListener(this);
        View view3 = bannerLayout.findViewById(R.id.banner_integral);
        TextView textView3 = (TextView) view3.findViewById(R.id.tv_banner_name);
        textView3.setText("积分入户");
        view3.setOnClickListener(this);
        View view4 = bannerLayout.findViewById(R.id.banner_agent);
        TextView textView4 = (TextView) view4.findViewById(R.id.tv_banner_name);
        textView4.setText("深户代办");
        view4.setOnClickListener(this);

        bannerView = (BannerView) bannerLayout.findViewById(R.id.bannerView);
        ...
        mAdapter.setOnPageTouchListener(new BannerBaseAdapter.OnPageTouchListener<BannerBean>() {
            ...
            public void onPageClick(int position, BannerBean bannerBean) {
                // 页面点击
                Toast.makeText(getActivity(), bannerBean.title, Toast.LENGTH_SHORT).show();
            }
    ...
    private void initBannerData() {
        ...
        datas.add(new BannerBean(R.mipmap.tab_video_normal, "第一页"));
        datas.add(new BannerBean(R.mipmap.tab_video_normal, "第二页"));
        datas.add(new BannerBean(R.mipmap.tab_video_normal, "第三页"));
        datas.add(new BannerBean(R.mipmap.tab_video_normal, "第四页"));
        datas.add(new BannerBean(R.mipmap.tab_video_normal, "第五页"));
        datas.add(new BannerBean(R.mipmap.tab_video_normal, "第六页"));
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.banner_public:
                Intent intent = new Intent(mActivity, WebViewActivity.class);
                intent.putExtra(WebViewActivity.URL, "http://baidu.com");
                startActivity(intent);
                break;
            case R.id.banner_parse:
                intent = new Intent(mActivity, WebViewActivity.class);
                intent.putExtra(WebViewActivity.URL, "http://baidu.com");
                startActivity(intent);
                break;
            case R.id.banner_integral:
                intent = new Intent(mActivity, WebViewActivity.class);
                intent.putExtra(WebViewActivity.URL, "http://baidu.com");
                startActivity(intent);
                break;
            case R.id.banner_agent:
                intent = new Intent(mActivity, WebViewActivity.class);
                intent.putExtra(WebViewActivity.URL, "http://baidu.com");
                startActivity(intent);
                break;
    ...
    public void initData() {
        ...
        if(bundle != null){
            mChannelCode = bundle.getString(Constant.CHANNEL_CODE);
            isVideoList = bundle.getBoolean(Constant.IS_VIDEO_LIST, false);
    ...
    public void initListener() {
        ...
        mNewsAdapter.setHeaderView(bannerLayout);
